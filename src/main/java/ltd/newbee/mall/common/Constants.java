...
public class Constants {
    public final static String FILE_UPLOAD_DIC = "/home/zb/IdeaProjects/newbee-mall-master/newbee-mall-master/src/main/resources/upload/";//上传文件的默认url前缀，根据部署设置自行修改
